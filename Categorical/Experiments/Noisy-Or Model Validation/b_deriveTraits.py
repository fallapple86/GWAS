...
if __name__ == "__main__":
    ...
    ## File "ErrorUsers" contains a list of OpenSNP users whose genetic test files can not be read
    ...
    def loadgroup(trait):
        traitfile = util.remove_invalid_filename(trait + ".txt")
    ...
    ## In this experiments, only traits with both groups more than 10 users are qualified for further experiments
    ### remove the user that cannot be read and extract the qualified traits
    ### save to file "b_remove_error_user"
